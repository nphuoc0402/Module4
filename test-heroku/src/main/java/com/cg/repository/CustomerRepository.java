...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
    ...
    @Query("SELECT NEW com.cg.model.dto.CustomerDTO (c.id, c.fullName, c.email, c.phone, c.locationRegion, c.balance) FROM Customer c WHERE c.deleted = false ")
    ...
    @Query("SELECT NEW com.cg.model.dto.CustomerDTO (c.id, c.fullName, c.email, c.phone, c.locationRegion, c.balance) FROM Customer c WHERE c.id = ?1 ")
